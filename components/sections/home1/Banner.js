        ...
        >
          <SwiperSlide className="swiper-slide">
            <div
              ...
              style={{
                backgroundImage: "url(assets/img/slider/background.webp)",
              }}
            ></div>
          ...
          <SwiperSlide className="swiper-slide">
            <div
              className="image-layer"
              style={{
                backgroundImage: "url(assets/img/slider/background2.webp)",
              }}
            ></div>
            <div className="shape1">
              <img src="assets/img/shape/slider-v1-shape1.png" alt="" />
          ...
          <SwiperSlide className="swiper-slide">
            <div
              className="image-layer"
              style={{
                backgroundImage: "url(assets/img/slider/background3.webp)",
              }}
            >
              {" "}
            </div>
